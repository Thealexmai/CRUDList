...
c.execute('create table users(email varchar(100) primary key, firstname varchar(100), lastname varchar(100), password varchar(100), service INTEGER, description varchar(100), buyer INTEGER, picture varchar(100), location varchar(100))')
